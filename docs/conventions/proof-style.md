...
*(Part of the project conventions; see `LANGUAGE.md` for the index. This
is the DEPTH file behind the top-level `docs/style.md`: start there for
the principles, come here for the worked idioms, the raw-CIC tells, the
when-to-hint judgment, and the redundancy-check polishing workflow.)*
