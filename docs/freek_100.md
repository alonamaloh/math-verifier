...
Next in the series arc: **#78** (Cauchy–Schwarz) on the finite-sum
machinery (`library/Real/series.math`). **#38** (arithmetic/geometric mean) waits on a √ construction.
