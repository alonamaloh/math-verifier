#!/usr/bin/env python3
"""Generate finite base tables, the 12 selected odd-C5 covers, and auxiliary covers.
...
The auxiliary odd-C5 r1c4 form is the odd-C4 r1c5 determinant-seven target
after exchanging the last two coordinates.
"""
...
module Algebra.{module_name}

import Algebra.rank_four_odd_c5_cover

{"".join(rendered)}{extra_theorems}"""
...
def render_outputs() -> dict[Path, str]:
    ...
    outputs[AUXILIARY_R1_C4] = table_module(
        "rank_four_odd_c5_auxiliary_r1_c4_generated",
        1,
        4,
        cover_theorem(1, 4),
    )
