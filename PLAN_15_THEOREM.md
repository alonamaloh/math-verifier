...
- `S3.C1` `[~]` (M) ★ The set of truants occurring anywhere in the tree is exactly **{1,2,3,5,6,7,10,14,15}**. — owes: S3.E3, S3.E4, S3.E5, S5.U2, S5.U3
  ...
  **LOW-RANK AND EXCEPTIONAL FINITE CASES COMPLETE 2026-07-21:**
  ...
  conditional universality proofs. The remaining escalation obligation is
  to prove the rank-five extensions of the six exceptional forms universal,
  and the remaining classical obligation is to discharge the explicitly
  named ternary converse interfaces used by the 201 proofs. In particular,
