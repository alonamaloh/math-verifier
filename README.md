...
- **Quadratic forms & the Fifteen Theorem (in progress):** symmetric
  ...
  untrusted search and rechecked in full by the kernel**. This development
  lives outside the library, in `projects/FifteenTheorem/` (`make -j 16
  projects`) — see `projects/README.md`,
  `projects/FifteenTheorem/fifteen-theorem.md`, and `PLAN_15_THEOREM.md`.
...
- **`library/<Area>/README.md`** — the entry point for a library area
  ...
  `projects/README.md` — developments that use the library without being
  part of it; `projects/FifteenTheorem/fifteen-theorem.md` maps the
  quadratic-forms development, and `PLAN_15_THEOREM.md` is its
  stage-by-stage plan and authoritative progress tracker.
